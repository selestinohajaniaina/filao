        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light"> </span> Controlisation de depence
            </h4>
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-4 col-12 mb-md-0 mb-4">
                    <div class="card">
                      <h5 class="card-header">Ajout nouveau</h5>
                      <div class="card-body">
                        <form id="formAuthentication" class="mb-3" action="add.php" method="POST">
                          <div class="mb-3 form-password-toggle">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <label class="form-label" for="">Cout de Depence (AR)</label>
                                
                            </div>
                            <div class="input-group input-group-merge">
                                <input type="number" class="form-control" name="cout" placeholder="Cout de Depence" required/>
                            </div>
                            <div class="d-flex justify-content-between">
